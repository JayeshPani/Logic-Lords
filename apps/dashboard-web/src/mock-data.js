...
export const MOCK_DATA = Object.freeze({
  ...
  automationIncidents: [
    {
      ...
      trigger_reason: "risk_level=Critical; forecast_or_risk_failure_probability>=0.60",
      created_at: isoMinusHours(1),
      updated_at: isoMinusHours(1),
      authority_notified_at: isoMinusHours(1),
      authority_ack_deadline_at: new Date(NOW.getTime() + 12 * 60 * 1000).toISOString(),
      ...
      police_dispatch_ids: [],
      inspection_ticket_id: "insp_20260214_0042",
      maintenance_id: null,
    },
  ],
  verification: {
    verification_id: "vfy_20260214_0001",
    command_id: "11af5f64-5d44-4f5f-b39b-bf11f0747a7d",
    ...
    submitted_at: isoMinusHours(3),
    confirmed_at: isoMinusHours(2),
    failure_reason: null,
  ...
  verificationState: {
    ...
    verification_tx_hash: "0x" + "b".repeat(64),
    verification_error: null,
    verification_updated_at: isoMinusHours(2),
  },
  activeMaintenanceId: "mnt_20260214_0012",
  evidenceByMaintenanceId: {
    mnt_20260214_0012: [
      {
        evidence_id: "evd_20260214_0001",
        maintenance_id: "mnt_20260214_0012",
        asset_id: "asset_w12_bridge_0042",
        filename: "repair_report.pdf",
        content_type: "application/pdf",
        size_bytes: 512000,
        storage_uri: "gs://infraguard-evidence/infraguard/evidence/mnt_20260214_0012/evd_20260214_0001/repair_report.pdf",
        sha256_hex: "a".repeat(64),
        uploaded_by: "org-admin-01",
        uploaded_at: isoMinusHours(4),
        finalized_at: isoMinusHours(3),
        status: "finalized",
        category: "repair_report",
        notes: "Primary maintenance report bundle.",
      },
    ],
  },
